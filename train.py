...
def train():
    ...
    #z_samp = tf.placeholder(tf.float32, [FLAGS.Samples_number, FLAGS.z_dim], name='z_samp')
    # get images
    ...
    #summary_op_test_2 = tf.summary.merge_all(key="Test2")
...
# =============================================================================
#             saver = tf.train.Saver()
#             saver.restore(sess, str("C:/Users/ksxl806/Documents/PythonScripts/LF_DCGAN/LF_DCGAN/checkpoints/LF_DCGAN/model.ckp.index"))
#             print("Model restored.")
# =============================================================================
        tf.reset_default_graph()  
        imported_meta = tf.train.import_meta_graph("C:/Users/ksxl806/Documents/PythonScripts/LF_DCGAN/LF_DCGAN/checkpoints/LF_DCGAN_377_547/model.ckp.meta")        
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        if (FLAGS.restore_model == "True"):
            imported_meta.restore(sess, tf.train.latest_checkpoint('"C:/Users/ksxl806/Documents/PythonScripts/LF_DCGAN/LF_DCGAN/checkpoints/LF_DCGAN_377_547/checkpoint'))
